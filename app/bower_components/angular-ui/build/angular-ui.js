 ...
 * @example <input ui-keypress="{enter:'x = 1-1', 'ctrl-shift-space':'foo()', 'shift-13':'bar()'}" /> <input ui-keypress="foo = 2 on ctrl-13 and bar('hello') on shift-esc" />
 **/
 ...
 *  string: all instances of $1 will be replaced
 *  array: each instance of $1, $1-1, $2 etc. will be placed with each array item in corresponding order
 *  object: all attributes will be iterated through, with :key being replaced with its corresponding value
 * @return string
 *
 * @example: 'Hello :name, how are you :day'.format({ name:'John', day:'Today' })
 * @example: 'Records $1 to $1-1 out of $2 total'.format(['10', '20', '3000'])
 * @example: '$1 agrees to all mentions $1 makes in the event that $1 hits a tree while $1 is driving drunk'.format('Bob')
 */
