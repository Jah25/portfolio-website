describe('highlight', function () {
  ...
  describe('case insensitive', function () {
    ...
    it('should work correctly for number filters', function () {
      expect(highlightFilter('3210123', 0)).toEqual('321<span class="ui-match">1</span>123');
    });
    it('should work correctly for number text', function () {
      expect(highlightFilter(3210123, '1')).toEqual('321<span class="ui-match">1</span>123');
    });
  });
  describe('case sensitive', function () {
    ...
    it('should work correctly for number filters', function () {
      expect(highlightFilter('3210123', 0, true)).toEqual('321<span class="ui-match">1</span>123');
    });
    it('should work correctly for number text', function () {
      expect(highlightFilter(3210123, '1', true)).toEqual('321<span class="ui-match">1</span>123');
    });
