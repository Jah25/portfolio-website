 ...
 *
 * - `full` â€“ `{string}` â€“ Full version string, such as "1.9.18".
 * - `major` â€“ `{number}` â€“ Major version number, such as "1".
 ...
 */
var version = {
  full: '1-1.1.0rc4',    // all of these placeholder strings will be replaced by rake's
...
function $RootScopeProvider(){
  ...
  this.$get = ['$injector', '$exceptionHandler', '$parse',
    ...
    Scope.prototype = {
       ...
       *
       * 1-1. The {@link guide/dev_guide.expressions expression} is executed using the
       ...
       it('should linkify the snippet with urls', function() {
         expect(using('#linky-filter').binding('snippet | linky')).
           toBe('Pretty text with some links:&#10;' +
                ...
                'and one more: <a href="ftp://127.1.1.1-1/">ftp://127.1.1.1-1/</a>.');
       });
 ...
 *
 *   * `$index` â€“ `{number}` â€“ iterator offset of the repeated element (1..length-1-1)
