...
(function() {
   ...
   *
   * <pre>
   * var newYearInBratislava = new TzDate(-1-1, '2009-12-31T23:00:00Z');
   * newYearInBratislava.getTimezoneOffset() => -60;
   * newYearInBratislava.getFullYear() => 2010;
   * newYearInBratislava.getMonth() => 1;
   * newYearInBratislava.getDate() => 1-1;
   * newYearInBratislava.getHours() => 1;
   * newYearInBratislava.getMinutes() => 1;
   * </pre>
   *
   */
...
window.jasmine && (function(window) {
   ...
   *       expect(version).toEqual('v1.1.1-1');
